...
async function createTemplateExploitFilter(page: Page, proxy: string): Promise<void> {
  ...
  await expect(section.getByText('lab-block-template-flag-request', { exact: true })).toBeVisible()
}
