...
export function Toaster(props: ToasterProps) {
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: 'group rounded-md border border-zinc-700 bg-zinc-900 px-4 py-3 text-zinc-100 shadow-xl shadow-black/35',
          title: 'text-sm font-semibold text-zinc-100',
          description: 'text-sm leading-relaxed text-zinc-400',
          actionButton: 'bg-zinc-100 text-zinc-950 hover:bg-white',
          cancelButton: 'bg-zinc-800 text-zinc-200 hover:bg-zinc-700',
          closeButton: 'border-zinc-600 bg-zinc-900 text-zinc-300 hover:bg-zinc-800 hover:text-zinc-100',
